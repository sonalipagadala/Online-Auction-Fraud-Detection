        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1" valign="top"> <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              Products</font></strong> <br> <br> <br> <form name="f" action="off_search.jsp" method="post" onsubmit="return valid()">
                <table bgcolor="#FFFFFF" width="700" border="0">
                  ...
                  <tr bgcolor="#E4E4F1"> 
                    ...
                    <td align="center"><font color="#110022"><strong>Trustability</strong></font></td>
...
%>
                  <tr bgcolor="#FFFFCC"> 
                    ...
                    <td align="center"><a href="admin_trust.jsp?<%=pid%>"><strong><font color="#CC0000">View</font></strong></a></td>
                  </tr>
                  <%	  
}
	   }
