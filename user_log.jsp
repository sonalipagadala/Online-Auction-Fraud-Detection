        ...
        <table height="350" align="center" width="700">
          <tr bgcolor="#CC3300"> 
            <td width="610" bgcolor="#FBF7E1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              ...
              Login</font></strong> <br> <br> <br> <form name="s" action="user_log1.jsp" method="get" onsubmit="return valid()">
            ...
            <td width="147" bgcolor="#F3ECC2"> <table>
                ...
                <tr> 
                  <td align="center"><font face="Comic Sans MS" size="+1"><a href="#">User</a></font></td>
                </tr>
                <tr> 
